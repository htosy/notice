...
button_tag_search = QPushButton("Шукати замітки по тег")
...
layout_notice.addLayout(col_1,stretch = 2   )
layout_notice.addLayout(col_2,stretch = 1)

notes_win.setLayout(layout_notice)
notes_win.show()
app.exec_()